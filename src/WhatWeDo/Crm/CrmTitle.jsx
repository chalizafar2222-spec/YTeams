    ...
    >
      ...
      <div className="absolute bottom-10 left-10 md:left-20 max-w-3xl">
        <div className="bg-white/30 backdrop-blur-md rounded-2xl p-8 shadow-lg">
          <h1 className="text-4xl font-bold text-white mb-4">D365 CRM</h1>
          <p className="text-lg text-white leading-relaxed mb-6">
            Strengthen customer relationships with Microsoft Dynamics 365 CRM — 
            a powerful solution to manage sales, marketing, and customer service 
            with intelligence, automation, and insights.
          </p>
